...
public:
    ...
    bool select_method(/*nbvplanner::dcsp_srv::Request &req, nbvplanner::dcsp_srv::Request &res*/);
            ...
            if (is_new_value_consistent) {
                ...
                for (it3 = lower_priority_agents.begin(); it3 != lower_priority_agents.end(); ++it3){
                    ...
                    if (lower_priority_agent == "firefly1") {
                     ...
                     ros::NodeHandle n;
                     ros::ServiceClient client = n.serviceClient<nbvplanner::dcsp_srv>(service_name);
                     nbvplanner::dcsp_srv srv;
...
void dcsp_srv_2_recieve_ok(){
    ...
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<nbvplanner::dcsp_srv>("dcsp_srv_2");
    nbvplanner::dcsp_srv srv;
    srv.request.init_agent_identifier = NULL;
    srv.request.init_point = NULL;
    srv.request.agents = NULL;
...
void dcsp_srv_3_recieve_ok(){
        ...
        ros::NodeHandle n;
        ros::ServiceClient client = n.serviceClient<nbvplanner::dcsp_srv>("dcsp_srv_3");
        nbvplanner::dcsp_srv srv;
        srv.request.init_agent_identifier = NULL;
        srv.request.init_point = NULL;
        srv.request.agents = NULL;
...
bool Agent::select_method(nbvplanner::dcsp_srv::Request &req, nbvplanner::dcsp_srv::Request &res){
